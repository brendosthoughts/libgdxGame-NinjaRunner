...
//		spikeRightTexture = new TextureRegion(spikeLeftTexture);
		...
		bobDoubleJumpRightAnimation= new Animation(RUNNING_FRAME_DURATION, bobDoubleJumpRight);
		bobDoubleJumpLeftAnimation= new Animation(RUNNING_FRAME_DURATION, bobDoubleJumpLeft);
		...
		skeletonLeftAnimation = new Animation(RUNNING_FRAME_DURATION*2, skeletonLeftFrames);
		...
		skeletonRightAnimation = new Animation(RUNNING_FRAME_DURATION*2, skeletonRightFrames);
